/**
 * @file 模块 `entry/demo/hello/project` - View定义
 *
...
define(function (require) {
    ...
    /**
     * 模块 `entry/demo/hello/project` - View定义
     *
     * @class
     * @extends {er.View}
     */
    ...
    /**
     * @property {string} template 所使用的模板，entry-demo-hello-project1-loading就是加载时的模板，require它来自动使用
     */
    overrides.template = 'entry-demo-hello-project1';
