/**
 * @file 模块 `entry/demo/hello/project` - Model定义
 *
...
define(function (require) {
    ...
    overrides.defaultArgs = {
        structure: {},
        steps: [
            '项目初始化<br /><code class="console">'
                + [
                    'mkdir project && cd project',
                    'edp project init .'
                ].join('<br />')
                + '</code>',
            '适当引入需要的库：<code class="console">edp import fc-view fc-ajax fc-storage jquery</code>',
            '增加 html：<code class="console">efc add main.html</code>',
            '增加 js：<code class="console">efc add src/main.js</code>',
            '更多：<code class="console">efc --help</code>'
        ]
    };
